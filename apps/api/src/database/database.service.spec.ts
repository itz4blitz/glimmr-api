...
describe("DatabaseService", () => {
  ...
  describe("rawClient getter", () => {
    ...
    it("should throw error when client is not initialized", () => {
      expect(() => service.rawClient).toThrow(
  ...
  describe("transaction", () => {
    it("should execute transaction successfully", async () => {
      ...
      const mockTransactionCallback = jest
        .fn()
      ...
      expect(mockDrizzleDb.transaction).toHaveBeenCalledWith(
    ...
    it("should handle transaction errors", async () => {
      ...
      await expect(
        service.transaction(mockTransactionCallback),
  ...
  describe("withLogging", () => {
    ...
    it("should log failed query execution", async () => {
      ...
      await expect(service.withLogging(operation, mockQuery)).rejects.toThrow(
        queryError,
      );
