...
export const hospitals = pgTable(
  ...
  (table) => ({
    ...
    activeStateIdx: index("hospitals_active_state_idx").on(
      table.isActive,
      table.state,
    ),
    activeStateCityIdx: index("hospitals_active_state_city_idx").on(
      table.isActive,
      table.state,
      table.city,
    ),
    activeLastUpdatedIdx: index("hospitals_active_last_updated_idx").on(
      table.isActive,
      table.lastUpdated,
    ),
