...
export const analytics = pgTable(
  ...
  (table) => ({
    ...
    calculatedAtIdx: index("analytics_calculated_at_idx").on(
      table.calculatedAt,
    ),
    metricPeriodIdx: index("analytics_metric_period_idx").on(
      table.metricName,
      table.period,
    ),
    statePeriodIdx: index("analytics_state_period_idx").on(
      table.state,
      table.period,
    ),
  }),
