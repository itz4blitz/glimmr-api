...
import { IsString, IsNotEmpty, IsOptional, IsUUID, IsArray, IsBoolean, IsDate } from 'class-validator';
...
export class CreatePermissionDto {
  ...
  @ApiProperty({ description: 'Action name', enum: ['read', 'write', 'delete', 'execute', 'admin'] })
  @IsString()
  @IsNotEmpty()
