...
describe('Custom Exceptions', () => {
  describe('BusinessLogicException', () => {
    ...
    it('should create exception with custom status code', () => {
      const exception = new BusinessLogicException('Test message', HttpStatus.INTERNAL_SERVER_ERROR);
  ...
  describe('HospitalNotFoundException', () => {
    it('should create exception with hospital ID', () => {
      ...
      expect(exception.message).toBe(`Hospital with ID ${hospitalId} not found`);
  ...
  describe('InvalidFileFormatException', () => {
    it('should create exception with file name and expected format', () => {
      ...
      const exception = new InvalidFileFormatException(fileName, expectedFormat);
      
      expect(exception.message).toBe(`Invalid file format for ${fileName}. Expected: ${expectedFormat}`);
      expect(exception.getStatus()).toBe(HttpStatus.BAD_REQUEST);
    });
  ...
  describe('ExternalServiceException', () => {
    ...
    it('should create exception with service name and message', () => {
      ...
      expect(exception.message).toBe(`External service ${serviceName} error: ${message}`);
      expect(exception.getStatus()).toBe(HttpStatus.BAD_GATEWAY);
    });
  ...
  describe('RateLimitExceededException', () => {
    ...
    it('should create exception with service name and retry after', () => {
      ...
      expect(exception.message).toBe(`Rate limit exceeded for ${service}. Retry after ${retryAfter} seconds`);
      expect(exception.getStatus()).toBe(HttpStatus.TOO_MANY_REQUESTS);
    });
  ...
  describe('DatabaseOperationException', () => {
    ...
    it('should create exception with operation name and details', () => {
      ...
      expect(exception.message).toBe(`Database operation failed: ${operation}. ${details}`);
      expect(exception.getStatus()).toBe(HttpStatus.INTERNAL_SERVER_ERROR);
    });
  ...
  describe('ValidationException', () => {
    it('should create exception with field and value only', () => {
      ...
      expect(exception.message).toBe(`Validation failed for field '${field}' with value '${value}'`);
    ...
    it('should create exception with field, value, and reason', () => {
      ...
      expect(exception.message).toBe(`Validation failed for field '${field}' with value '${value}': ${reason}`);
      expect(exception.getStatus()).toBe(HttpStatus.UNPROCESSABLE_ENTITY);
    });
    ...
    it('should handle complex values', () => {
      ...
      expect(exception.message).toBe(`Validation failed for field '${field}' with value '[object Object]'`);
      expect(exception.getStatus()).toBe(HttpStatus.UNPROCESSABLE_ENTITY);
    });
  ...
  describe('ConfigurationException', () => {
    it('should create exception with config key', () => {
      ...
      expect(exception.message).toBe(`Configuration error: ${configKey} is not properly configured`);
      expect(exception.getStatus()).toBe(HttpStatus.INTERNAL_SERVER_ERROR);
    });
  ...
  describe('JobProcessingException', () => {
    ...
    it('should create exception with job name and message', () => {
      ...
      expect(exception.message).toBe(`Job processing failed: ${jobName}. ${message}`);
      expect(exception.getStatus()).toBe(HttpStatus.INTERNAL_SERVER_ERROR);
    });
