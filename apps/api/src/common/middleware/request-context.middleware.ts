...
export class RequestContextMiddleware implements NestMiddleware {
  ...
  private setupResponseLogging(req: ExtendedRequest, res: Response, startTime: number): void {
    ...
    res.end = function(this: Response, chunk?: any, encoding?: any, cb?: () => void): Response {
      try {
        ...
        const logData = {
          ...
          contentLength: contentLength ? parseInt(contentLength.toString(), 10) : undefined,
        };
