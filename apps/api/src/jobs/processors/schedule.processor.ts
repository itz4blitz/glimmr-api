    ...
    try {
      ...
      for (const { schedule, template } of dueSchedules) {
        try {
          ...
          const templateConfig = typeof template.defaultConfig === 'object' ? template.defaultConfig : {};
          const scheduleConfig = typeof schedule.jobConfig === 'object' ? schedule.jobConfig : {};
