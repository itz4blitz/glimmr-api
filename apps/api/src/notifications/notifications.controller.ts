...
import { CreateNotificationDto, UpdateNotificationDto, NotificationFiltersDto, UpdateNotificationPreferencesDto } from './dto/notifications.dto'
...
export class NotificationsController {
  ...
  updatePreferences(@Request() req, @Body() updatePreferencesDto: UpdateNotificationPreferencesDto) {
    return this.notificationsService.updatePreferences(req.user.id, updatePreferencesDto)
  }
