...
export class ODataController {
  ...
  @ApiResponse({
    status: 200,
    description: "OData service document retrieved successfully",
  })
  @ApiResponse({
    status: 500,
  ...
  @ApiResponse({
    status: 200,
    description: "OData metadata document retrieved successfully",
  })
  @ApiResponse({
    status: 500,
    description: "Internal server error",
  ...
  @ApiResponse({
    status: 200,
    description: "Prices data retrieved successfully",
  })
  @ApiResponse({
    status: 400,
    description: "Bad request - invalid query parameters",
