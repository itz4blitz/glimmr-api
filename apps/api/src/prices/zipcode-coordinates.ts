...
export const zipcodeCoordinates: Record<string, { lat: number; lng: number }> =
  {
    ...
    "19101": { lat: 39.954, lng: -75.1657 }, // Philadelphia, PA
    ...
    "02101": { lat: 42.3554, lng: -71.054 }, // Boston, MA
 ...
 */
export function getCoordinatesForZipcode(zipcode: string): {
  lat: number;
  lng: number;
} {
  ...
  const nearbyZip = Object.keys(zipcodeCoordinates).find((zip) =>
