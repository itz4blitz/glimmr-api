...
describe("UsersService", () => {
  ...
  describe("findByEmail", () => {
    ...
    it("should handle database errors", async () => {
      mockDatabaseService.db.limit.mockRejectedValue(
        new Error("Database error"),
      );

      await expect(service.findByEmail("testuser@example.com")).rejects.toThrow(
        "Database error",
      );
    });
  });
  ...
  describe("create", () => {
    ...
    it("should handle database constraint violations", async () => {
      ...
      mockDatabaseService.db.returning.mockRejectedValue(
