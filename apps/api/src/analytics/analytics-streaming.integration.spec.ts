...
describe('Analytics Streaming Integration', () => {
  ...
  describe('GET /analytics/export/stream', () => {
    it('should stream JSON data successfully', async () => {
      ...
      expect(response.headers['content-disposition']).toContain('attachment; filename="glimmr-hospitals-export-');
    ...
    it('should handle database errors gracefully', async () => {
      mockDatabaseService.db.offset.mockRejectedValue(new Error('Database connection failed'));
    ...
    it('should include proper Content-Disposition header with date', async () => {
      ...
      expect(response.headers['content-disposition']).toContain(`glimmr-hospitals-export-${today}.json`);
    });
  });
