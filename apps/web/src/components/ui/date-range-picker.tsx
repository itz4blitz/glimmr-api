        ...
        <div className="p-4">
          <Calendar
            ...
            classNames={{
              ...
              button_previous:
                "h-9 w-9 bg-transparent hover:bg-accent hover:text-accent-foreground inline-flex items-center justify-center rounded-md",
              button_next:
                "h-9 w-9 bg-transparent hover:bg-accent hover:text-accent-foreground inline-flex items-center justify-center rounded-md",
              weekdays: "flex gap-1 mb-2",
              weekday:
                "text-muted-foreground rounded-md w-[2.75rem] font-medium text-sm",
              week: "flex gap-1",
