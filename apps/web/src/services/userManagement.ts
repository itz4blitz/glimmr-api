...
export class UserManagementService {
  ...
  static async updateUserRole(id: string, data: UpdateUserRoleDto): Promise<UserWithProfile> {
  ...
  // Profile Management
  static async updateUserProfile(id: string, data: ProfileUpdateData): Promise<UserWithProfile> {
    const response = await apiClient.put(`/users/${id}/profile`, data)
    return response.data
  }

  static async updateUserPreferences(id: string, data: PreferencesUpdateData): Promise<UserWithProfile> {
    const response = await apiClient.put(`/users/${id}/preferences`, data)
    return response.data
  }

  // Bulk Operations
  static async bulkUserAction(action: BulkUserActionDto): Promise<BulkActionResult> {
  ...
  static async getUserActivity(userId: string, params: PaginationParams = {}): Promise<ActivityLogResponse> {
  ...
  // Utility Methods
  static async checkEmailAvailability(email: string, excludeUserId?: string): Promise<boolean> {
...
export const userManagementApi = {
  ...
  updateUserPreferences: withErrorHandling(UserManagementService.updateUserPreferences),
  ...
  resendEmailVerification: withErrorHandling(UserManagementService.resendEmailVerification),
  ...
  checkEmailAvailability: withErrorHandling(UserManagementService.checkEmailAvailability),
  getUserPermissions: withErrorHandling(UserManagementService.getUserPermissions),
  updateUserPermissions: withErrorHandling(UserManagementService.updateUserPermissions),
  ...
  revokeAllUserSessions: withErrorHandling(UserManagementService.revokeAllUserSessions),
}
