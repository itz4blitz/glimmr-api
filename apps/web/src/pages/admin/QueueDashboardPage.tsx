...
import { TriggerJobModalEnhanced } from '@/components/admin/TriggerJobModalEnhanced'

export function QueueDashboardPage() {
  const [showLogsModal, setShowLogsModal] = useState<{ queueName: string; displayName: string } | null>(null)
